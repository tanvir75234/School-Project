...
<div class="hero-slide owl-carousel site-blocks-cover">
    @foreach($banner as $banner)
        <div class="intro-section img-fluid w-100" style="background-image: url({{ asset('contents/uploads/banner/'.$banner->banner_images) }})">
            <div class="container">
    ...
    <div class="section-bg style-1" style="background-image: url('{{ asset('website') }}/images/about_1.jpg');">
    <div class="container">
        <div class="row">
        <div class="col-lg-4">
    ...
    <div class="container">
        ...
        <div class="col-lg-9">
            ...
            <div class="col-lg-6">
                ...
                <a href="news-single.html" class="img-link"><img src="{{ asset('website') }}/images/blog_large_1.jpg" alt="Image" class="img-fluid"></a>
            ...
            <div class="col-lg-6">
                ...
                <a href="news-single.html" class="img-link mr-4"><img src="{{ asset('website') }}/images/blog_1.jpg" alt="Image" class="img-fluid"></a>
                <div class="post-content">
                    <div class="post-meta">
                    <a href="#">June 6, 2019</a>
                    <span class="mx-1">/</span>
                ...
                <div class="post-entry-big horizontal d-flex mb-4">
                <a href="news-single.html" class="img-link mr-4"><img src="{{ asset('website') }}/images/blog_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="post-content">
                    <div class="post-meta">
                    <a href="#">June 6, 2019</a>
                    <span class="mx-1">/</span>
