...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a href="#" class="small mr-3"><span class="icon-phone2 mr-2"></span> {{ $contact->cm_phone }}</a> 
            <a href="#" class="small mr-3"><span class="icon-envelope-o mr-2"></span> {{ $contact->cm_email }}</a> 
          </div>
    ...
    <div class="container">
        <div class="row">
        <div class="col-lg-3">
            <p class="mb-4"><img src="{{ asset('website') }}/images/logo.png" alt="Image" class="img-fluid"></p>
